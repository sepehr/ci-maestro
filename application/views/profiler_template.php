<!-- -------------------------------------- PROFILER ----------------------------------------------- -->
<style type="text/css">
	#codeigniter-profiler { clear: both; background: #101010; padding: 0 5px; font-family: Helvetica, "Helvetica World", sans-serif; font-size: 10px !important; line-height: 12px; position: absolute; width: auto; min-width: 55em; max-width: 90%; z-index: 1000; display: none; }
	...
	.ci-profiler-box h2 { font-family: Helvetica, "Helvetica World", sans-serif; font-weight: bold; font-size: 16px !important; padding: 0; line-height: 2.0; }
	...
	#codeigniter-profiler table.main td { padding: 7px 15px; text-align: left; vertical-align: top; color: #aaa; border-bottom: 1px dotted #444; line-height: 1.5; background: #101010 !important; font-size: 13px !important; font-family: "Consolas", "Bitstream Vera Sans Mono"; font-style: italic; }
